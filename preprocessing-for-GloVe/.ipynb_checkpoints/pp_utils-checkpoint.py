...
def plot_accuracies() : 
    ...
    plt.plot(history_pp0.history['val_binary_accuracy'])
    plt.plot(history_pp1.history['val_binary_accuracy'])
    plt.plot(history_pp2.history['val_binary_accuracy'])
    plt.plot(history_pp3.history['val_binary_accuracy'])  
