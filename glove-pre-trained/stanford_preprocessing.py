"""
stanford_preprocessing.py "Some random text with #hashtags, @mentions and http://t.co/kdjfkdjf (links). :)"
...
"""
#the following code has been slightly modified from the above source to be used with ease
